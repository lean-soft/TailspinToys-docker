...
namespace Tailspin.Infrastructure {
    ...
    public class DbCommon {
        ...
        public DbCommon(string connectionStringName) {
            //TODO: doesn't work on IIS, cannot get environment variable when running in IIS (container)
            //connString = Environment.GetEnvironmentVariable("TailspinConnectionString", EnvironmentVariableTarget.Machine);
